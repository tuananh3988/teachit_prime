...
<div id="node-<?php print $node->nid; ?>" class="post <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php if ($node->type == 'blog' || $node->type == 'article') { ?>
    <h2<?php print $title_attributes; ?> class="blogTitle"><?php print $title; ?></h2>
  <?php } else { ?>
  ...
  <?php if ($display_submitted): ?>
    <div class="submitted meta clearfix">
      ...
      <?php if (!empty($node->comment_count)): ?>
        - <span class="comment-count"><a href="<?php print $node_url; ?>#comments" ><?php print $node->comment_count; ?> <?php print t('comments'); ?></a></span>
      <?php endif; ?>
  ...
  <?php if (!$page): ?>
    <a class="read-more" href="<?php print $node_url; ?>"><?php print t('Continue Reading'); ?></a>
  <?php endif; ?>
  <?php if ($page): ?>
