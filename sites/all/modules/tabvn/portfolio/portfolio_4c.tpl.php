    ...
    <?php if (!empty($nodes)): ?>
      ...
      <ul class="portfolio group col4"> 
        ...
        foreach ($nodes as $node) :
          ...
          <li class="span3 item featuredWork" data-id="id-<?php print $i; ?>" data-type="<?php print portfolio_format_terms('field_portfolio_category', $node); ?>">
