...
<div class="tabvn_tweet_widget widget_twitter">
  ...
  <script type="text/javascript" src="http://api.twitter.com/1.1/statuses/user_timeline.json??screen_name=<?php print $twitter_username; ?>&count=<?php print $tweets_count; ?>"></script>
